          ...
          }
          {
            ...
            <TouchableOpacity
             ...
             >
              {
                this.state.paused?
                <Icon onPress={this._resume} name='ios-play' size={48} style={styles.resumeIcon}/>:   <Text></Text>
              }
             </TouchableOpacity>
             :
             null
        ...
        >
          ...
          <View style={styles.commentBox}>
            <View style={styles.comment}>
              <TextInput placeholder='评论一个' style={styles.content} multiline={true} onFocus={this._focus} />
            </View>
          </View>
        </ScrollView>
        <View>
        ...
        <Modal
          ...
          >
            <View style={styles.modalContainer}>
              ...
              <View style={styles.commentBox}>
                <View style={styles.comment}>
                  <TextInput placeholder='评论一个' style={styles.content} multiline={true}
                  onBlur={this._blur}
